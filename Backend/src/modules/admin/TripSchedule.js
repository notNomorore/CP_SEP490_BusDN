...
const TripScheduleSchema = new mongoose.Schema(
  {
    ...
    incidentDelayMinutes: { type: Number, min: 0, max: 1440, default: 0 },
    propagatedDelayMinutes: { type: Number, min: 0, max: 1440, default: 0 },
    adjustedStartAt: { type: Date, default: null },
    adjustedEndAt: { type: Date, default: null },
